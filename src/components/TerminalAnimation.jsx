...
const COMMANDS = [
  ...
  { cmd: 'git log --oneline -6', out: 'a3f91c2 led 170-person global team across ops, events, AI\nb8d04e1 built ai compliance tool — caught what manual review missed\nc2a17f3 opened 3 offices from the ground up\nd9e82b0 restored comms during hurricane katrina\ne4c55a9 flew to tokyo. rebuilt the team. proposed to blythe there.\nf1b3310 honor grad, e-5 in three years' },
  { cmd: 'ls ~/projects', out: 'dadops-bot/  unicornland/  family-lights/  image-forge/  chrispowell.ai/' },
  { cmd: 'brew install hobbies', out: 'installing: projection-mapping, laser-engraving, cnc-routing, photography, 3d-printing, drone...' },
  { cmd: 'cat faa-legacy.txt', out: 'national safety initiative POC — briefed senior leadership. fixed nav aids for ATC. 2008-2011.' },
  { cmd: 'cat mentorship.log', out: '12+ managers elevated to senior roles. still counting.' },
  ...
  { cmd: 'cat saturday.txt', out: '→ snooze AM with waverly → dance unlimited. every week.' },
